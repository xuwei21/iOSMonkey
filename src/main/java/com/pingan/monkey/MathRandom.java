...
/**
 * Created by xuwei21 on 16/12/23.
 */
public class MathRandom {
     ...
     * 0出现的概率为%40
     */
    public static double EVENT_TYPE_TAP = 0.5;
    /**
     * 1出现的概率为%30
     */
    public static double EVENT_TYPE_SWIPE = 0.2;
    /**
     * 2出现的概率为%10
     */
    public static double EVENT_TYPE_BACK = 0.10;

    public static double EVENT_TYPE_SUBMIT = 0.0;

    public static double EVENT_TYPE_CONTENT = 0.0;
    
    public static double EVENT_TYPE_SPECIAL_POINT = 0.0;
    
    public static double  EVENT_TYPE_HOMEKEY = 0.2;
